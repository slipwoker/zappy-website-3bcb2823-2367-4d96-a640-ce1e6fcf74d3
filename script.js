            ...
            if (isValid) {
                ...
                setTimeout(() => {
                    ...
                    if (!contactForm.querySelector('.form-success')) {
                        ...
                        successMessage.style.cssText = 'color: #38a169; padding: 1rem; margin-top: 1rem; text-align: center;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '3bcb2823-2367-4d96-a640-ce1e6fcf74d3',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '3bcb2823-2367-4d96-a640-ce1e6fcf74d3';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '3bcb2823-2367-4d96-a640-ce1e6fcf74d3';
